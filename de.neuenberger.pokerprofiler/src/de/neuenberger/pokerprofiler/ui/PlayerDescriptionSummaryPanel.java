...
public class PlayerDescriptionSummaryPanel extends JPanel {
	...
	public static final ImageIcon IMG_C = new ImageIcon(getImage("c.png"));
	public static final ImageIcon IMG_F = new ImageIcon(getImage("f.png"));
	public static final ImageIcon IMG_B = new ImageIcon(getImage("b.png"));
	public static final ImageIcon IMG_R = new ImageIcon(getImage("r.png"));
	public static final ImageIcon IMG_C_F = new ImageIcon(getImage("c_f.png"));
	public static final ImageIcon IMG_B_F = new ImageIcon(getImage("b_f.png"));
	public static final ImageIcon IMG_R_F = new ImageIcon(getImage("r_f.png"));
	public static final ImageIcon IMG_C_C = new ImageIcon(getImage("c_c.png"));
	public static final ImageIcon IMG_C_R = new ImageIcon(getImage("c_r.png"));

	public static final ImageIcon IMG_TRASH = new ImageIcon(
			getImage("trashplay.png"));
	public static final ImageIcon IMG_VPIP = new ImageIcon(getImage("vpip.png"));
	public static final ImageIcon IMG_DEALER_VP = new ImageIcon(
			getImage("dealer_vp.png"));
	public static final ImageIcon IMG_AGGR = new ImageIcon(
			getImage("aggressive.png"));
	public static final ImageIcon IMG_SLOW = new ImageIcon(
			getImage("slowplay.png"));
	public static final ImageIcon IMG_CONTI = new ImageIcon(
			getImage("contibet.png"));
	public static final ImageIcon IMG_CONTIBF = new ImageIcon(
			getImage("contibetfold.png"));
	public static final ImageIcon IMG_WONWSF = new ImageIcon(
			getImage("wonwhensawflop.png"));
	public static final ImageIcon IMG_WINNER = new ImageIcon(
			getImage("winner.png"));

	public static final ImageIcon IMG_WONSD = new ImageIcon(
			getImage("wonshowdown.png"));
	public static final ImageIcon IMG_WTS = new ImageIcon(
			getImage("wenttoshowdown.png"));
	public static final ImageIcon IMG_HANDS = new ImageIcon(
			getImage("hands.png"));
	public static final ImageIcon IMG_DWIN = new ImageIcon(
			getImage("dollarwin.png"));

	public static final ImageIcon IMG_SD_HIGHCARD = new ImageIcon(
			getImage("highcard.png"));
	public static final ImageIcon IMG_SD_PAIR = new ImageIcon(
			getImage("pair.png"));
	public static final ImageIcon IMG_SD_TWOPAIR = new ImageIcon(
			getImage("twopair.png"));
	public static final ImageIcon IMG_SD_TRIPLETS = new ImageIcon(
			getImage("triplets.png"));
	public static final ImageIcon IMG_SD_STRAIGHT = new ImageIcon(
			getImage("straight.png"));
	public static final ImageIcon IMG_SD_FLUSH = new ImageIcon(
			getImage("flush.png"));
	public static final ImageIcon IMG_SD_FULLHOUSE = new ImageIcon(
			getImage("fullhouse.png"));
	public static final ImageIcon IMG_SD_QUADS = new ImageIcon(
			getImage("quads.png"));
	public static final ImageIcon IMG_SD_STRAIGHTFLSH = new ImageIcon(
			getImage("straightflush.png"));

	public static final ImageIcon IMG_POCKET_AX = new ImageIcon(
			getImage("pocket_ax.png"));
	public static final ImageIcon IMG_POCKET_KX = new ImageIcon(
			getImage("pocket_kx.png"));
	public static final ImageIcon IMG_POCKET_CONNECTOR = new ImageIcon(
			getImage("pocket_connector.png"));
	public static final ImageIcon IMG_POCKET_SUITED = new ImageIcon(
			getImage("pocket_suited.png"));
	public static final ImageIcon IMG_POCKET_PAIR = new ImageIcon(
			getImage("pocket_pair.png"));
	...
	JLabel jlDealerVoluntaryPlay = new JLabel();
	...
	static URL getImage(final String name) {
		return PokerProfiler.class.getResource("images/" + name);
	}

	public PlayerDescriptionSummaryPanel(final boolean compact) {
		if (compact) {
			setupCompact();
			setSmallFont();
		} else {
		...
		jlDealerVoluntaryPlay.setToolTipText("Dealer Voluntary Play");
		...
		jlDealerVoluntaryPlay.setIcon(IMG_DEALER_VP);
	...
	protected void setupCompact() {
		final GridLayout vgrid = new GridLayout(5, 3);
	...
	protected void setupComplete() {
		final GridLayout vgrid = new GridLayout(10, 5);
		...
		this.add(jlPlaysSlow);
		this.add(jlPlaysTrash);
		this.add(jlDealerVoluntaryPlay);
		this.add(jlPFRaise);
	...
	private void setAllForegroundColors(final Color foreground,
	...
	/**
	 * @return the jlDealerVoluntaryPlay
	 */
	public JLabel getJlDealerVoluntaryPlay() {
		return jlDealerVoluntaryPlay;
	}
}
